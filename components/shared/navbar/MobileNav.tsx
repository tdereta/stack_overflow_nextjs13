                ...
                <SheetClose asChild key={item.route}>
                    ...
                    className={`${isActive 
                       ...
                       className={`${isActive ? "" : "invert-colors"}`}/>
                        <p className={`${isActive ? 'base-bold' 
                            : 'base-medium'}`}>{item.label}</p>
                    </Link>
                </SheetClose>
                )
            })}
        ...
        <Sheet>
            ...
            <SheetContent side="left"
                ...
                <Link href="/" className="flex items-center gap-1">
                    <Image src="/assets/images/site-logo.svg" width={23} height={23}
                           alt="DevFlow" />
                    <p className="h2-bold text-dark100_light900 font-spaceGrotesk">
                        Rent a <span className="text-primary-500">Boat</span></p>
                </Link>
                <div>
                    <SheetClose asChild>
                        <NavContent />
